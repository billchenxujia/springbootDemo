 ...
 * LocalTime类使用演示：
 * <p>
 * 存储日期和时间。这会存储类似'2010-07-23T15:47:25.890'的日期时间
 * <p>
 * 创建时间：2019年4月4日
 *
 * @author chenxj
...
public class LocalTimeDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("小时：" + hour + "，分钟：" + minute + ",秒数：" + second); // 小时：10，分钟：5,秒数：53
		...
		System.out.println("相差小时：" + betweenHours + " 分钟: " + betweenMinutes + " 秒数：" + betweenSeconds); // 相差小时：2 分钟:
																											// 178
																											// 秒数：10707
